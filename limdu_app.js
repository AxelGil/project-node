...
(async function () {
  ...
  intentClassifier.trainBatch([
    ...
    { input: "Je souhaite suivre l evolution de mes candidatures recentes", output: "candidature" },
    { input: "J aimerais connaitre le statut de mes demandes d emploi en cours", output: "candidature" },
    { input: "Je voudrais verifier les reponses aux candidatures que j ai soumises", output: "candidature" },
    { input: "Je desire consulter les retours des entreprises sur mes candidatures", output: "candidature" },
    { input: "Je suis intéresse par l avancement de mes demarches pour trouver un emploi", output: "candidature" },
    { input: "Je veux m assurer que mes candidatures sont bien prises en consideration", output: "candidature" },
    { input: "Je suis motive a suivre de pres mes progres dans ma recherche d emploi", output: "candidature" },
    { input: "Je souhaite suivre l evolution de mes candidatures recentes", output: "candidature" },
    { input: "J aimerais connaître le statut actuel de mes demandes d emploi", output: "candidature" },
    { input: "Je voudrais verifier les reponses reçues suite a mes soumissions de candidatures", output: "candidature" },
    { input: "Je desire consulter les retours des entreprises concernant mes candidatures", output: "candidature" },
    { input: "Je suis interesse par le suivi de mes demarches pour trouver un emploi", output: "candidature" },
    { input: "Je souhaite m assurer que mes candidatures sont prises en consideration comme il se doit", output: "candidature" },
    { input: "Je suis motive a observer de pres mes avancees dans ma quete d emploi", output: "candidature" },
  ]);
